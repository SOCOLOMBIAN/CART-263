...
/***CODE */  console.log(document.querySelectorAll(".img-container img")[7]);
/***OUTPUT: 
 * 
...
/***CODE */
document.querySelector("p").textContent='New text in paragraph one:text changed by Sophie Sanchez on the following date: January 27';
/*************************************** */
