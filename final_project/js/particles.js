class particleBackground {
    ...
    init() {
        ...
        // creation of the stars based on the screen size
        this.createStars();
    ...
    // creation of the stars (fixed method name)
    createStars() {
        this.stars = [];
        ...
        for (let i = 0; i < this.options.particleCount; i++) {
            this.stars.push({
                ...
                alpha: Math.random(),
                delta: Math.random() * 0.02 - 0.01  // Fixed delta value
            });
        }
    }
